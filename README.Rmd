...
*Notice in the output dataframe: The `bbd`, `canopy`, `aspect_deg`, `forest_type`, and `plot_area_ha` columns, which are additional (not required) columns in the internal dataframe, remain in the output dataframe. Any additional columns in the internal or external dataframe will remain in the output dataframe.*
